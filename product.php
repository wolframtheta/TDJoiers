...
<title><?php include_once("../name.php"); ?> - Producte</title>
</head>
<body>
	<div id="web">
		<?php
		...
		<div id="products">
			<div id="button_product">
				...
				<div class="button_product" style="top:86px; left:287px;">
					<span class="title_left">ALIANCES</span><br />
					<span class="subtitle_left">Aliances, d'or, plata...</span>
				</div>
			</div>
			<div id="button_product">
				...
				<div class="button_product" style="top:86px; left:570px; text-align:left;">
					<span class="title_right">ANELLS</span><br />
					<span class="subtitle_right">Solitaris, rossetons...<br />D'or, plata, acer...</span>
				</div>
			</div>
			<div id="button_product">
				<a href="product/necklaces.php"><img class="button2" src="img/buttons/product-necklaces.jpg"/>
				<div class="button_product" style="top:86px; left:287px;">
					<span class="title_left">PENJOLLS</span><br />
					<span class="subtitle_left">Penjolls i collars, d'or, plata,<br />amb perles...</span>
				</div>
			</div>
			<div id="button_product">
				<a href="product/bracelets.php"><img class="button2" src="img/buttons/product-bracelets.jpg"/>
				<div class="button_product" style="top:86px; left:570px; text-align:left;">
					<span class="title_right" >POLSERES</span><br />
					<span class="subtitle_right">Polseres, braçalets, esclaves...<br />D'or, plata, acer, macramé...</span>
				</div>
			</div>
			<div id="button_product">
				...
				<div class="button_product" style="top:86px; left:247px;">
					<span class="title_left">ARRACADES</span><br />
					<span class="subtitle_left">De perles, clàssiques,<br />modernes, criolles...</span>
				</div>
			</div>
			<div id="button_product">
				<a href="product/baby.php"><img class="button2" src="img/buttons/product-baby.jpg"/>
				<div class="button_product" style="top:86px; left:570px; text-align:left;">
					<span class="title_right">NEDÓ</span><br />
					<span class="subtitle_right">Arracades, Polseres...</span>
				</div>
			</div>
 </div>
 <?php
