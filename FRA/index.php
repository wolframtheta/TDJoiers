...
<div id="web">
 ...
 <div id="bottom_menu">
  <a href="aboutus.php"><img class="button" src="img/buttons/ProposDeNous.png" style="margin-top:71px;margin-right:98px;margin-left:-319px;"></a>
  <a href="product.php"><img class="button" src="img/buttons/Produit.png"style="margin-right:98px;"></a>
  <a href="brands.php"><img class="button" src="img/buttons/Marques.png" style="margin-right:98px;"></a>
  <a href="whereweare.php"><img class="button" src="img/buttons/OuNousSommes.png" style="margin-right:-319px;"></a>
 </div>
 <?php
